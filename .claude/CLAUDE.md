# `docs.stickler` — public documentation repository

This is the **public** documentation site for `gomatic/stickler`, created from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs). It is published to GitHub Pages (and/or Cloudflare).
